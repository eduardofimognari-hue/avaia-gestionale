  ...
  return withAzienda(async (aziendaId) => {
    ...
    const updated = await prisma.terreni.update({
      ...
      data: {
        ...
        numeroPiante: body.numeroPiante !== undefined ? body.numeroPiante : undefined,
        annoImpianto: body.annoImpianto !== undefined ? body.annoImpianto : undefined,
        culturaVarieta: body.culturaVarieta !== undefined ? body.culturaVarieta : undefined,
        sistemaIrrigazioneId: body.sistemaIrrigazioneId !== undefined ? (body.sistemaIrrigazioneId ?? null) : undefined,
        portaInnestoId: body.portaInnestoId !== undefined ? (body.portaInnestoId ?? null) : undefined,
